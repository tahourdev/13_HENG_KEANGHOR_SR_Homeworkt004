...
export default function AddNewProjectComponent({ assignmentHandle }) {
  const [formData, setFormData] = useState({
    name: '',
    dueDate: '',
    progress: '',
    description:
      'New Project Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque autem perferendis incidunt tenetur alias quod, atque, non sapiente, illo eveniet nobis? In dicta, atque repellendus esse exercitationem quibusdam voluptate laudantium.',
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      assignmentHandle(formData.name, formData.dueDate, formData.progress, formData.description);
      setFormData({
        name: '',
        dueDate: '',
        progress: '',
          ...
          <div className="relative bg-white rounded-2xl shadow-sm dark:bg-gray-700">
            ...
            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
              ...
              <div className="text-right">
                <button
                  type="submit"
                  className="text-white inline-flex items-center bg-custom-sky-blue
                  hover:bg-custom-sky-blue-500 focus:ring-4 focus:outline-none focus:ring-custom-sky-blue-500
                  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-custom-sky-blue-500
                  dark:hover:bg-custom-sky-blue-500 dark:focus:ring-custom-sky-blue-500">
                  Create
                </button>
              </div>
            </form>

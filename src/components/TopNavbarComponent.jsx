...
export default function TopNavbarComponent({ setSearchQuery }) {
    ...
    <div className="flex justify-between items-center gap-8">
      <form className="relative w-9/12 ">
        ...
        <button className="cursor-pointer">
          <Search className="w-6 h-6 text-primary-text absolute top-1/2 -translate-1/2 left-8" />
        </button>
        ...
        <input
          ...
          className="w-full bg-white py-8 pl-14 pr-5 rounded-xl h-12 border-none focus:border-none focus:ring-0 focus:outline-custom-sky-blue"
        />
      </form>
